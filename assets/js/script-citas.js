...
$("#a-agendar").click(function(){
	...
	else
	{
		if($("#a-agendar").val()=='Mostrar')
		{
			...
			{
				$("#a-agendar").val('Modificar');		
			}
		}
		else
		{
			if($("#a-agendar").val()=='Modificar')
			{
				var parametros = {
						age_codigo: $("#cita").html(),
						tipo_trans: "busca-cita"
				    	...
				    	if(respuesta.codigo == 1)
				      	{
				        	...
				        	else
				        	{
					        	...
					        	{
					        		alert("La cita ya fue confirmada, No se puede modificar");
					        	}
					        	else
					        	{
...
function asignarCita(tipoasig)
{
	var numerodevisita = "";
	if($("#vez2").prop("checked"))
	{
		numerodevisita = "P";
	}
	else
