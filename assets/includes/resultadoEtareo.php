...
<html>
	...
	<body>
		<section>
			...
			$consulta = "SELECT * FROM tb_matriz_grupo_etareo WHERE mge_mes_reg='" .$_GET['mes'] . "' AND mge_profesional='".$_GET['profesional'] ."'";
			...
			<table id="t-resultado" border="1" style="font-size:10px;">
				<tr>
					...
					<th class="t-header" rowspan="2">Circuito</th>
			...
			if ($resultado)
			{
				...
				while ($row = mysql_fetch_assoc($resultado)) 
				{
					...
					?>
						...
						<td><?php echo $row['mge_sexo'];?></td>
					<?php
						if($row['mge_edad']>4 && $row['mge_edad']<10)
						{
							if($row['mge_imc']==1)
							{
								echo "<td>".$row['mge_visita']."</td>";	
							}
							else
							{
								echo "<td></td>";
